...
public class InitServlet extends HttpServlet {
	...
	public void init() throws ServletException {
	    ...
	    // creazione auto
 		...
 		Auto auto2 = new Auto ("Berlina", "Alfa Romeo", "Giulietta", "Automatico", 1956.0, "Nero", 4, "CC111DD", "Diesel", 130.0, "giulietta.jpg");
 		...
 		Auto auto5 = new Auto ("Berlina", "Citroen", "C3-Aircross", "Manuale", 1499.0, "Nero", 5, "II444LL", "Diesel", 110.0, "c3.jpg");
 		
 		Auto auto6 = new Auto ("Utilitaria", "Fiat", "500", "Manuale", 1242.0, "Grigio", 4, "MM555NN", "Benzina", 80.0, "500.jpg");
 		Auto auto7 = new Auto ("SUV", "Peugeot", "3008", "Automatico", 1997.0, "Nero", 5, "OO666PPP", "Diesel", 240.0, "3008.jpg");
 		Auto auto8 = new Auto ("Utilitaria", "Ford", "Fiesta", "Manuale", 1400.0, "Bianco", 4, "FF333HH", "GPL", 110.0, "fiesta.jpg");
 		Auto auto9 = new Auto ("SUV", "Ford", "Kuga", "Automatico", 1500.0, "Bianco", 5, "UU999VV", "Benzina", 230.0, "kuga.jpg");
 		Auto auto10 = new Auto ("Utilitaria", "Fiat", "Panda", "Manuale", 1000.0, "Bianca", 4, "QQ777RR","GPL", 80.0, "panda.jpg");
 		
 		Auto auto11= new Auto ("SUV", "Kia", "Sportage", "Automatico", 1598.0, "Grigio", 5, "ZZ661ZZ", "Diesel", 230.0, "Sportage.jpg");
 		...
 		Auto auto14 = new Auto ("Sportiva", "Lamborghini", "URUS", "Automatico", 3996.0, "Grigio", 5, "AA078BN", "Benzina", 1200.0, "urus.jpg");
 		...
 		Auto auto18 = new Auto ("Utilitaria", "Opel", "Corsa", "Manuale", 1499.0, "Bianco", 5, "HH606LL", "Diesel", 100.0, "corsa.jpg");
 		Auto auto19 = new Auto ("SUV", "Opel", "Mokka", "Automatico", 1498.0, "Grigio", 5, "II707MM", "Diesel", 170.0, "mokka.jpg");
 		Auto auto20 = new Auto ("SUV", "Renault", "Kadjar", "Manuale", 1600.0, "Bianco", 5, "NN808PP", "Benzina", 190.0, "kadjar.jpg");
 		
 		Auto auto21 = new Auto ("Station Wagon", "Renault", "Clio - Sporter", "Manuale", 1500.0, "Grigio", 5, "OO909QQ", "Diesel", 170.0, "cliosporter.jpg");
 		...
 		Auto auto25 = new Auto ("Utilitaria", "Volkswagen", "Polo", "Manuale", 1498.0, "Nero", 4, "SS201UU", "Benzina", 100.0, "polo.jpg");
 		
 		Auto auto26 = new Auto ("SUV", "Volkswagen", "Tiguan", "Automatico", 2000.0, "Grigio", 5, "VV302KK", "Benzina", 250.0, "tiguan.jpg");
 		Auto auto27 = new Auto ("Sportiva", "Ford", "Mustang Fastback", "Automatico", 4951.0, "Blu e Nero", 2, "ZA672BT", "Benzina", 700.0, "fastback.jpg");
 		Auto auto28 = new Auto ("SUV", "Jeep", "Compass", "Automatico", 1598.0, "Bianca", 5, "BN498SL", "Benzina", 250.0, "compass.jpg");
 		/*
 		Auto auto29 = new Auto ("SUV", "Alfa Romeo", "Stelvio", "Automatico", 2143.0, "Grigio", 5, "LR456BD", "Diesel", 230.0, "Stelvio.jpg");
